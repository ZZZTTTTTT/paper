...
loss,val_losses = model.train_model(X_train, Y_train, n_epochs = 80, target_len = ow, batch_size = 128, training_prediction = 'mixed_teacher_forcing', teacher_forcing_ratio = 0.6, learning_rate = 0.005, dynamic_tf = False)
